...
from click import BadParameter, style
...
# -------------------------------------
LHS=Frame(Body,width=310,height=435,bg='#f4f5f5',highlightbackground='#abacb1',highlightthickness=1)
LHS.place(x=10,y=10)
...
l5=Label(LHS,text=f"Total RAM installed:{round(psutil.virtual_memory().total/10000000,2)} GB",bg='#f4f5f5',font=('Acumin Variable Concept',15),justify='center')
l5.place(x=20,y=310)
...
def weather():
    ...
    def getweather():
        try:
            ...
            geolocator=Nominatim(user_agent='geoapiExeercises')
    ...
    # time
    name=Label(app1,font=('arial',15,'bold'),fg='#f4f5f5')
    name.place(x=30,y=100)
    clock=Label(app1,font=('Helvetica',20),bg='#f4f5f5')
    clock.place(x=30,y=130)

    # lable
    lable1=Label(app1,text='WIND',font=('Helvatica',15,'bold'),fg='white',bg='#1ab5ef')
    lable1.place(x=120,y=400)

    lable2=Label(app1,text='HUMIDITY',font=('Helvatica',15,'bold'),fg='white',bg='#1ab5ef')
    lable2.place(x=250,y=400)

    lable3=Label(app1,text='DESCRIPTION',font=('Helvatica',15,'bold'),fg='white',bg='#1ab5ef')
    lable3.place(x=430,y=400)

    lable4=Label(app1,text='PRESSURE',font=('Helvatica',15,'bold'),fg='white',bg='#1ab5ef')
    lable4.place(x=650,y=400)

    t=Label(app1,font=('arial',70,'bold'),fg='#ee666d',bg='#f4f5f5')
    t.place(x=400,y=150)
    c=Label(app1,font=('arial',70,'bold'),bg='#1ab5ef')
    c.place(x=400,y=250)
...
def clock():
    ...
    lbl=Label(app2,font=('digital-57',50,'bold'),width=20,bg='#f4f5f5',fg='#292e2e')
...
# -------------------------------------
RHB=Frame(Body,width=470,height=190,bg='#f4f5f5',highlightbackground='#abacb1',highlightthickness=1)
